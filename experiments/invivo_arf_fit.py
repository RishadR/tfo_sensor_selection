...
def fit_and_save_invivo_arf(
    output_path: Path = Path("models/invivo_arf.pkl"),
    seed: int = 42,
    *,
    arf_params: dict[str, Any],
) -> None:
    cfg = load_metadata("invivo")
    df = load_dataset(cfg)
...
if __name__ == "__main__":
    fit_and_save_invivo_arf(
        output_path=Path("models/invivo_arf.pkl"),
        seed=42,
        arf_params={
            "num_trees": 50,
            "delta": 0.0,
